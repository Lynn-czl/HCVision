...
public class JDialogRecordSchedule extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		jComboBoxWeekDay.setModel(
				new javax.swing.DefaultComboBoxModel(new String[] { "星期一", "星期二", "星期三", "星期四", "星期五", "星期六", "星期天" }));
		...
		jComboBoxRecordType.setModel(new javax.swing.DefaultComboBoxModel(
				new String[] { "定时录像", "移动侦测", "报警录像", "动测|报警", "动测&报警", "命令触发", "智能录像" }));
		...
		jComboBoxRecordType1.setModel(new javax.swing.DefaultComboBoxModel(
				new String[] { "定时录像", "移动侦测", "报警录像", "动测|报警", "动测&报警", "命令触发", "智能录像" }));
		...
		jComboBoxRecordType2.setModel(new javax.swing.DefaultComboBoxModel(
				new String[] { "定时录像", "移动侦测", "报警录像", "动测|报警", "动测&报警", "命令触发", "智能录像" }));
		...
		jComboBoxRecordType3.setModel(new javax.swing.DefaultComboBoxModel(
				new String[] { "定时录像", "移动侦测", "报警录像", "动测|报警", "动测&报警", "命令触发", "智能录像" }));
		...
		jComboBoxRecordType4.setModel(new javax.swing.DefaultComboBoxModel(
				new String[] { "定时录像", "移动侦测", "报警录像", "动测|报警", "动测&报警", "命令触发", "智能录像" }));
		...
		jComboBoxRecordType5.setModel(new javax.swing.DefaultComboBoxModel(
				new String[] { "定时录像", "移动侦测", "报警录像", "动测|报警", "动测&报警", "命令触发", "智能录像" }));
		...
		jComboBoxRecordType6.setModel(new javax.swing.DefaultComboBoxModel(
				new String[] { "定时录像", "移动侦测", "报警录像", "动测|报警", "动测&报警", "命令触发", "智能录像" }));
		...
		jComboBoxRecordType7.setModel(new javax.swing.DefaultComboBoxModel(
				new String[] { "定时录像", "移动侦测", "报警录像", "动测|报警", "动测&报警", "命令触发", "智能录像" }));
		...
		jComboBoxRecordType8.setModel(new javax.swing.DefaultComboBoxModel(
				new String[] { "定时录像", "移动侦测", "报警录像", "动测|报警", "动测&报警", "命令触发", "智能录像" }));
