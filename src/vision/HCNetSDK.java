...
public interface HCNetSDK extends StdCallLibrary {
	...
	public static class NET_DVR_ALARMINFO_V30 extends Structure {// 上传报警信息(9000扩展)
		public int dwAlarmType;/*
								 * 0-信号量报警,1-硬盘满,2-信号丢失,3－移动侦测,4－硬盘未格式化,5-
								 * 读写硬盘出错, 6-遮挡报警,7-制式不匹配, 8-非法访问,
								 * 0xa-GPS定位信息(车载定制)
								 */
	...
	public static class NET_DVR_ALARMINFO extends Structure {
		public int dwAlarmType;/*
								 * 0-信号量报警,1-硬盘满,2-信号丢失,3－移动侦测,4－硬盘未格式化,5-
								 * 读写硬盘出错, 6-遮挡报警,7-制式不匹配, 8-非法访问, 9-串口状态,
								 * 0xa-GPS定位信息(车载定制)
								 */
...
interface PlayCtrl extends StdCallLibrary {
	...
	int PlayM4_Pause(NativeLong nPort, int nPause);

	int PlayM4_Slow(NativeLong nPort);

	int PlayM4_Fast(NativeLong nPort);
