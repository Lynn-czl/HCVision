...
public class JDialogPTZCruise extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		jPanel2.setBorder(
				javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder("巡航点")));
	...
	private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonAddActionPerformed
		...
		bRet = Set_NET_DVR_PTZCruise(m_iChanNum, HCNetSDK.FILL_PRE_SEQ, (byte) m_iCruiseNum, (byte) m_iSeqPoint,
				(short) m_iPresetNum);
		if (bRet) {
			bRet = Set_NET_DVR_PTZCruise(m_iChanNum, HCNetSDK.SET_SEQ_DWELL, (byte) m_iCruiseNum, (byte) m_iSeqPoint,
					(short) m_iSeqDwell);
			if (bRet) {
				bRet = Set_NET_DVR_PTZCruise(m_iChanNum, HCNetSDK.SET_SEQ_SPEED, (byte) m_iCruiseNum,
	...
	private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonDeleteActionPerformed
		...
		m_iSeqPoint = jComboBoxCruisePoint.getSelectedIndex() + 1;
		m_iPresetNum = jComboBoxPresetPoint.getSelectedIndex() + 1;
		if (!hCNetSDK.NET_DVR_PTZCruise(m_lRealHandle, HCNetSDK.CLE_PRE_SEQ, (byte) m_iCruiseNum, (byte) m_iSeqPoint,
				(short) m_iPresetNum)) {
	...
	private boolean Set_NET_DVR_PTZCruise(int iChanNum, int dwPTZCruiseCmd, byte byCruiseRoute, byte byCruisePoint,
			short wInput) {
