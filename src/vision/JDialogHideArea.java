...
public class JDialogHideArea extends javax.swing.JDialog {
	 ...
	 *************************************************/
	public JDialogHideArea(javax.swing.JDialog parent, boolean modal, NativeLong lUserID, int iChannelNum,
	...
	private void initComponents() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(layout.createSequentialGroup().addGap(10, 10, 10).addComponent(jRadioButtonShowArea)
								.addGap(81, 81, 81).addComponent(jRadioButtonSetArea))
						.addComponent(panelPlay, javax.swing.GroupLayout.PREFERRED_SIZE, 352,
								javax.swing.GroupLayout.PREFERRED_SIZE))
				.addContainerGap(18, Short.MAX_VALUE))
				.addGroup(layout.createSequentialGroup().addGap(34, 34, 34).addComponent(jButtonSet)
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addContainerGap()
						...
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jRadioButtonShowArea).addComponent(jRadioButtonSetArea))
						.addGap(18, 18, 18)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jButtonSet).addComponent(jButtonExit))
		...
		for (k = 0; k < g_iHideAreaCount; k++) {
			if (g_rectHideAreaMouse[k].top <= g_rectHideAreaMouse[k].bottom) {
				if (g_rectHideAreaMouse[k].left <= g_rectHideAreaMouse[k].right) {
					...
					m_struPicCfg.struShelter[k].wHideAreaWidth = (short) ((g_rectHideAreaMouse[k].right
							- g_rectHideAreaMouse[k].left) * 2);
					m_struPicCfg.struShelter[k].wHideAreaHeight = (short) ((g_rectHideAreaMouse[k].bottom
							- g_rectHideAreaMouse[k].top) * 2);
				} else {
					m_struPicCfg.struShelter[k].wHideAreaTopLeftX = (short) (g_rectHideAreaMouse[k].right * 2);
					m_struPicCfg.struShelter[k].wHideAreaTopLeftY = (short) (g_rectHideAreaMouse[k].top * 2);
					m_struPicCfg.struShelter[k].wHideAreaWidth = (short) ((g_rectHideAreaMouse[k].left
							- g_rectHideAreaMouse[k].right) * 2);
					m_struPicCfg.struShelter[k].wHideAreaHeight = (short) ((g_rectHideAreaMouse[k].bottom
							- g_rectHideAreaMouse[k].top) * 2);
				}
			} else {
				if (g_rectHideAreaMouse[k].left <= g_rectHideAreaMouse[k].right) {
					...
					m_struPicCfg.struShelter[k].wHideAreaWidth = (short) ((g_rectHideAreaMouse[k].right
							- g_rectHideAreaMouse[k].left) * 2);
					m_struPicCfg.struShelter[k].wHideAreaHeight = (short) ((g_rectHideAreaMouse[k].top
							- g_rectHideAreaMouse[k].bottom) * 2);
				} else {
					m_struPicCfg.struShelter[k].wHideAreaTopLeftX = (short) (g_rectHideAreaMouse[k].right * 2);
					m_struPicCfg.struShelter[k].wHideAreaTopLeftY = (short) (g_rectHideAreaMouse[k].bottom * 2);
					m_struPicCfg.struShelter[k].wHideAreaWidth = (short) ((g_rectHideAreaMouse[k].left
	...
	private void initialDialog() {
		...
		for (i = 0; i < HCNetSDK.MAX_SHELTERNUM; i++) {
			...
			g_rectHideAreaMouse[i].bottom = (m_struPicCfg.struShelter[i].wHideAreaTopLeftY
					+ m_struPicCfg.struShelter[i].wHideAreaHeight) / 2;
			g_rectHideAreaMouse[i].right = (m_struPicCfg.struShelter[i].wHideAreaTopLeftX
					+ m_struPicCfg.struShelter[i].wHideAreaWidth) / 2;
		}
